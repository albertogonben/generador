...
public class Generador {
	...
	private static String PLANTILLA_DTO = "dto.ftlh";
	...
	private static void generarDTO(Configuration cfg, Map parametros) throws Exception {
		new File(PATH_DESTINO + "/dto").mkdir();

//		DTO
		Template tempIRepository = cfg.getTemplate(PLANTILLA_DTO);

		File newFile = new File(PATH_DESTINO + "/dto/" + parametros.get("name") + "BO.java");
...
//		Postman
		...
		File newFile = new File(PATH_DESTINO + "/postman/" + parametros.get("name") + "-postman.json");
		newFile.createNewFile();
		Writer file = new FileWriter(newFile);
		tempIRepository.process(parametros, file);
...
//		IRepository
		...
		File newFile = new File(PATH_DESTINO + "/Repository/" + parametros.get("name") + "Repository.java");
		newFile.createNewFile();
		Writer file = new FileWriter(newFile);
		tempIRepository.process(parametros, file);
	}
...
//		IControler
		...
		File newFile = new File(PATH_DESTINO + "/Icontroller/I" + parametros.get("name") + "Controller.java");
		newFile.createNewFile();
		Writer file = new FileWriter(newFile);
