...
@RestController
@Api(value = "API celebrated sentence")
public interface ICelebratedSentenceController {

	@ApiOperation(value = "Get all celebrated sentence", response = String.class, responseContainer = "List")
